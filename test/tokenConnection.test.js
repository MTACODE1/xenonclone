...
// safe to create fixtures directly. It exercises: xero_tokens/organisations (upsertToken, markConnectionDisconnected, etc.)
...
test('tokenConnection.test.js is skipped pending a MySQL-safe rewrite', { skip: 'unsafe to run against the shared MySQL database as written — see file header' }, () => {});
