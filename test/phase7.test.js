...
// safe to create fixtures directly. It exercises: organisations/health_scores/sync_runs
...
test('phase7.test.js is skipped pending a MySQL-safe rewrite', { skip: 'unsafe to run against the shared MySQL database as written — see file header' }, () => {});
